...
#if ((4U != DIO_AR_RELEASE_MAJOR_VERSION)\
 ||  (0U != DIO_AR_RELEASE_MINOR_VERSION)\
 ||  (3U != DIO_AR_RELEASE_PATCH_VERSION))
  #error "The AR version of Dio_Cfg.h does not match the expected version"
#endif

/* Software Version checking between Dio_Cfg.h and Dio.h files */
#if ((1U != DIO_SW_MAJOR_VERSION)\
 ||  (0U != DIO_SW_MINOR_VERSION)\
 ||  (0U != DIO_SW_PATCH_VERSION))
